...
function Providers(t0) {
    ...
    if ($[0] !== "e92db969c1fb8c590ac6cb5d6e1db298237d7d38add4caf36b0482bf064eb73c") {
        for(let $i = 0; $i < 15; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "e92db969c1fb8c590ac6cb5d6e1db298237d7d38add4caf36b0482bf064eb73c";
    }
    const { children } = t0;
    const [themeId, setThemeId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("ice");
    let t1;
    if ($[1] !== themeId) {
        t1 = THEMES.find({
            "Providers[THEMES.find()]": (t)=>t.id === themeId
        }["Providers[THEMES.find()]"]) || THEMES[3];
        $[1] = themeId;
        $[2] = t1;
    } else {
        t1 = $[2];
...
_s(Providers, "7sNicBZWl1f5s7a3LWriWmb1tWY=");
_c = Providers;
function useTheme() {
    _s1();
...
//# sourceMappingURL=_d5d493e6._.js.map